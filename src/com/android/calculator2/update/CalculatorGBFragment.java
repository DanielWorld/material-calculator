...
import com.android.calculator2.RevealColorView;
...
public class CalculatorGBFragment extends Calculator {

    private Animator mCurrentAnimator;
    private RevealColorView revealColorView;

    public static CalculatorGBFragment newInstance() {
        return new CalculatorGBFragment();
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mDisplayView.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                revealColorView = new RevealColorView(getContext());
