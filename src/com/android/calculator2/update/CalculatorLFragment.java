...
public class CalculatorLFragment extends Calculator {

    private Animator mCurrentAnimator;

    public static CalculatorLFragment newInstance() {
        return new CalculatorLFragment();
    }
    ...
    void reveal(View sourceView, int colorRes, final AnimatorListenerWrapper listener) {
        final ViewGroupOverlay groupOverlay =
                (ViewGroupOverlay) getActivity().getWindow().getDecorView().getOverlay();
